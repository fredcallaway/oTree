...
same_games_dict[1] = np.array([[[3,1],[3,2],[3,3]], [[7,7],[4,5],[1,3]], [[5,4],[5,5],[2,3]]]) # Weak link
same_games_dict[2] = np.array([[[8,7],[8,8],[1,6]], [[9,9],[7,8],[0,5]], [[5,0],[6,1],[3,3]]]) # Prisoners
same_games_dict[3] = np.array([[[6,4],[6,6],[1,4]], [[4,0],[4,1],[4,4]], [[9,9],[4,6],[0,4]]]) # Stag-hunt
same_games_dict[4] = np.array([[[6,1],[5,0],[6,6]], [[8,8],[7,8],[1,4]], [[8,7],[9,9],[0,5]]]) # Sym
same_games_dict[5] = np.array([[[4,4],[3,5],[4,0]], [[5,3],[3,4],[3,2]], [[0,3],[1,3],[9,9]]]) # Max
#
# same_games_dict[31] = np.array([[[7,7],[4,5],[1,3]], [[5,4],[5,5],[2,3]], [[3,1],[3,2],[3,3]]]) # Weak link
# same_games_dict[37] = np.array([[[8,7],[8,8],[1,6]], [[9,9],[7,8],[0,5]], [[5,0],[6,1],[3,3]]]) # Prisoners
...
# same_games_dict[49] = np.array([[[4,4],[3,5],[4,0]], [[5,3],[3,4],[3,2]], [[0,3],[1,3],[9,9]]]) # Max
